...
" Highlighting {{{2
fu! ctrlp#syntax()
  " this is not the highlighting for the filename
	if ctrlp#nosy() | retu | en
	"silent! call GeneralSyntax()
	"silent! call TextSyntax()
...
if has('autocmd')
	aug CtrlPAug
		au!
		" As far as i can tell, BufEnter dosen't even work
	    " instead of using nunmap, i can do this to unmap for a certain
	    " filetype. this way it doesn't unmap for the entire of vim
		"au BufEnter ControlP call system('echo hi >> /tmp/hello')
		au BufEnter ControlP cal system('notify-send hi')
		au BufEnter ControlP silent! nnoremap <buffer> ch ch gh ge gf
		au BufEnter ControlP nnoremap <buffer> ch ch gh ge gf
