...
"      call Decho("l:cole=".&l:cole." l:cocu=".&l:cocu)
  ...
  " ------------------------------
  " Couldn't get this top one working
  " It's produced by tput sgr0
  syn region ansiNone		start="\e(B\e\[m"   end="\e\["me=e-2 contains=ansiConceal
  syn region ansiNone		start="\e\[(32m"    end="\e\["me=e-2 contains=ansiConceal
  ...
  syn region ansiNone		start="\e\[;\=0\{0,2};\=49m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiNone		start="\e\[;\=0\{0,2};\=4m"  end="\e\["me=e-2 contains=ansiConceal
